...
<script>try{document.documentElement.dataset.theme=(localStorage.getItem('ege-theme')==='light')?'':'dark';}catch(e){document.documentElement.dataset.theme='dark';}</script>
<style>
:root{
...
$('#theme').addEventListener('click', ()=>{
  ...
  localStorage.setItem('ege-theme', dark ? 'light' : 'dark');
  syncThemeColor();
});
